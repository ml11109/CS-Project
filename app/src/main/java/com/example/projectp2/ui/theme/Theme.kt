...
val ForestTheme = lightColorScheme(
    ...
    surfaceBright = Color(0xFFB1E0B3),   // Brighter mint
    surfaceDim = Color(0xFFA4DEA6),      // Slightly darker green
...
val SkyTheme = darkColorScheme(
    ...
    surface = Color(0xFF1E1E1E),         // Slightly lifted black
    surfaceBright = Color(0xFF2C2C2C),   // Brighter dark
    surfaceDim = Color(0xFF0F0F0F),      // Darkest tone
...
val StrawberryTheme = lightColorScheme(
    ...
    surfaceBright = Color(0xFFFCBDC7),   // Brighter pink
    surfaceDim = Color(0xFFFFB6C1),      // Muted pink
...
val OceanTheme = lightColorScheme(
    ...
    surfaceBright = Color(0xFF81D4FA),   // Bright water tone
    surfaceDim = Color(0xFF4FC3F7),      // Deeper sea blue
...
val SunriseTheme = lightColorScheme(
    ...
    surfaceDim = Color(0xFFFFB74D),      // Rich orange
